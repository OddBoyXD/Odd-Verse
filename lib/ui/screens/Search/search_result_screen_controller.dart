...
class SearchResultScreenController extends GetxController
  ...
  Future<void> _getInitSearchResult() async {
    ...
    if (args != null) {
      ...
      for (var tab in validTabs) {
        if (resultContent.containsKey(tab) ||
            (resultContent['searchEndpoint'] is Map &&
                (resultContent['searchEndpoint'] as Map).containsKey(tab))) {
          allKeys.add(tab);
        }
      }
      railItems.value = allKeys.toList();
      final len =
